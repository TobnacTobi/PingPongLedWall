...
class TextModePage extends StatefulWidget {
  ...
  @override
  _TextModePageState createState() => _TextModePageState();
}

class _TextModePageState extends State < TextModePage > implements ConnectionInterface {
  ...
  Widget build(BuildContext context) {
    return DefaultPage("Text", GestureDetector(
  ...
  void sendText() {
    ...
    textsettings['text'] = _textController.text;
